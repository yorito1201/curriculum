...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected static final String CONST_DESTINATION_RESULT_JSP = "/MVC_Task/src/main/webapp/employeeResult.jsp";
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
        	...
        	// EmployeeBean employeeBean = service.search(reqEmpId);←ここへ記述
